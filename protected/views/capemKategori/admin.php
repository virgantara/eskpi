	...
	$(document).ready(function(){
		$('#search,#size').change(function(){
			$('#capem-kategori-grid').yiiGridView.update('capem-kategori-grid', {
			    url:'<?php echo Yii::app()->createUrl("CapemKategori/admin"); ?>&filter='+$('#search').val()+'&size='+$('#size').val()
			});
		});
...
?>
<div class="pull-left"> <?php	echo CHtml::link('Tambah Baru',['CapemKategori/create'],['class'=>'btn btn-success']);
?></div>
