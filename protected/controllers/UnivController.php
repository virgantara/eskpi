...
class UnivController extends Controller
{
	 ...
	 * @return Univ the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Univ::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Univ $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='univ-form')
		{
