 ...
 *
 * The followings are the available columns in table '{{univ}}':
 * @property integer $id
 ...
 */
class Univ extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, kode, nama, nama_en, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Univ the static model class
	 */
