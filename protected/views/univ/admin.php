	...
	$(document).ready(function(){
		$('#search,#size').change(function(){
			$('#univ-grid').yiiGridView.update('univ-grid', {
			    url:'<?php echo Yii::app()->createUrl("Univ/admin"); ?>&filter='+$('#search').val()+'&size='+$('#size').val()
			});
		});
...
?>
<div class="pull-left"> <?php	echo CHtml::link('Tambah Baru',['Univ/create'],['class'=>'btn btn-success']);
?></div>
